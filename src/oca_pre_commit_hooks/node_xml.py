        ...
        for tag_name in lxml_by_tag:
            if tag_name in pos_by_tag:
                ...
                for i in range(min(len(lxml_list), len(pos_list))):
                    ...
                    if self._attributes_match(lxml_elem, pos_elem):
                        # Set position information as private attributes
                        lxml_elem._start_line = pos_elem.start_line
                        lxml_elem._start_col = pos_elem.start_col
                        lxml_elem._end_line = pos_elem.end_line
                        lxml_elem._end_col = pos_elem.end_col
                        lxml_elem._is_self_closing = pos_elem.is_self_closing
                        lxml_elem._position_attributes = pos_elem.attributes
