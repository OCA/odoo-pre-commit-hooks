 ...
 * xml-dangerous-qweb-replace-low-priority
    ...
    - https://github.com/OCA/odoo-pre-commit-hooks/blob/v0.0.9/test_repo/broken_module/template1.xml#L18 Dangerous use of "replace" from view with priority `0 < 99`
    - https://github.com/OCA/odoo-pre-commit-hooks/blob/v0.0.9/test_repo/broken_module/template1.xml#L4 Dangerous use of "replace" from view with priority `0 < 99`
    - https://github.com/OCA/odoo-pre-commit-hooks/blob/v0.0.9/test_repo/broken_module/template1.xml#L7 Dangerous use of "replace" from view with priority `0 < 99`
 ...
 * xml-syntax-error
    ...
    - https://github.com/OCA/odoo-pre-commit-hooks/blob/v0.0.9/test_repo/broken_module/file_no_exist.xml#L1 [Errno 2] No such file or directory: ''
    - https://github.com/OCA/odoo-pre-commit-hooks/blob/v0.0.9/test_repo/broken_module/file_no_exist.xml#L1 [Errno 2] No such file or directory: ''
 ...
 * po-python-parse-printf
    ...
    - https://github.com/OCA/odoo-pre-commit-hooks/blob/v0.0.9/test_repo/broken_module/i18n/es.po#L83 Translation string couldn't be parsed correctly using str%variables TypeError('%d format: a real number is required, not str')
 ...
 * po-syntax-error
    ...
    - https://github.com/OCA/odoo-pre-commit-hooks/blob/v0.0.9/test_repo/broken_module2/i18n/en.po#L1 Syntax error in po file (line 1)
